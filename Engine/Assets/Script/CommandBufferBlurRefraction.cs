...
public class CommandBufferBlurRefraction : MonoBehaviour
{
    ...
    public void OnWillRenderObject()
    {
        ...
        // get two smaller RTs
        // 這裏的Shader.PropertyToID 似乎只是一個類似hash code生成的函數，從一個string生成出來一個ID，使用該ID生成的RT即可用它來作爲handler被Blit調用。
        // Blit的調用又可以使用一個指定的Material.
        ...
        // 尝试Shader里传值。但似乎OnWillRenderObject函数是只运行一次的。。。
        buf.SetGlobalFloat("_GassianScale", GassianScale);
